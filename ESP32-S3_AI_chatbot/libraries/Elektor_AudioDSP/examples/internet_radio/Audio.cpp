...
//---------------------------------------------------------------------------------------------------------------------
Audio::Audio(const uint8_t BCLK, const uint8_t LRC, const uint8_t DOUT /* cpv */, const uint32_t sample_rate /* cpv end */) {
    //i2s configuration
    ...
    m_i2s_config.fixed_mclk           = 256*sample_rate;  // cpv - for ADAU1701
